...
(function() {
  var AudioLoader, AudioManager, Background, Cell, Fps, Gem, GemCascade, GemFactory, Grid, Input, Logger, Main, Menu, ProgressMeter, RoamingLight, Score, Timer,
    ...
    Menu.prototype.open = function(menu) {
      ...
      if (!this.cascade) {
        if (this.cascade == null) {
          this.cascade = new GemCascade(25);
        }
