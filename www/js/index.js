...
(function() {
  var Cell, Fps, Gem, GemFactory, Grid, Input, Jewels, Logger, Main,
  ...
  Cell = (function() {
    ...
    Cell.prototype.swapGem = function(cell) {
      ...
      cell.gem = this.gem;
      this.gem = new_gem;
      this.gem.swapTo(this.xPos(), this.yPos(), false);
      return cell.gem.swapTo(cell.xPos(), cell.yPos());
    };
  ...
  Grid = (function() {
    ...
    Grid.prototype.update = function(t) {
      ...
      if (this.ready_for_input && this.main.input.touching) {
        ...
        if (Math.abs(this.selected.x - current.x) + Math.abs(this.selected.y - current.y) > 1) {
          return this.stopInput();
        }
        if (this.selected === current) {
