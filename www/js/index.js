...
(function() {
  var AudioLoader, AudioManager, Cell, Fps, Gem, GemFactory, Grid, Input, Logger, Main, RoamingLight, Score, Screen, Timer,
  ...
  Grid = (function() {
    ...
    Grid.prototype.boardScale = function(i) {
      ...
      return GEMGAME.screen.realWidth() / this.w * i;
    };
  ...
  Main = (function() {
    function Main() {
      ...
      this.timer = new Timer(60, this.grid.boardScale(), this.grid_width);
  ...
  Timer = (function() {
    ...
    Timer.prototype.buildObject = function() {
      ...
      return this.object.add(this.cylinder);
    };
