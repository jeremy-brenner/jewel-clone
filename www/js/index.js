...
(function() {
  var AudioLoader, AudioManager, Cell, Fps, Gem, GemFactory, Grid, Input, Logger, Main, RoamingLight, Score,
  ...
  Cell = (function() {
    ...
    Cell.prototype.flagCleared = function() {
      ...
      if (this.horizontalMatches().length >= 3) {
        this.main.score.add(this.horizontalMatches().length);
      ...
      if (this.verticalMatches().length >= 3) {
        this.main.score.add(this.verticalMatches().length);
  ...
  Main = (function() {
    function Main() {
      ...
      this.roaming_light = new RoamingLight(this.realWidth(), this.input);
  ...
  RoamingLight = (function() {
    function RoamingLight(scale, input) {
      this.scale = scale;
      this.input = input;
    ...
    RoamingLight.prototype.xOffset = function() {
      return this.input.orientation.gamma * (Math.PI / 180) * -1 * this.scale;
    };

    RoamingLight.prototype.yOffset = function() {
      return this.input.orientation.beta * (Math.PI / 180) * this.scale;
    };
