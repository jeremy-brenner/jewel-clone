...
(function() {
  var AudioLoader, AudioManager, Background, Cell, Fps, Gem, GemCascade, GemFactory, Grid, Input, Logger, Main, Menu, MultiplierDisplay, ProgressMeter, RoamingLight, Score, ScoreBoard, Timer,
  ...
  Cell = (function() {
    ...
    Cell.prototype.flagCleared = function() {
      ...
      if (this.horizontalMatches().length >= 3 && this.hasSomeHope(this.horizontalMatches())) {
        GEMGAME.score.add(this.horizontalMatches().length, this.x, this.y);
      ...
      if (this.verticalMatches().length >= 3 && this.hasSomeHope(this.verticalMatches())) {
        GEMGAME.score.add(this.verticalMatches().length, this.x, this.y);
  ...
  Main = (function() {
    ...
    Main.prototype.init = function() {
      ...
      this.multiplier_display = new MultiplierDisplay();
